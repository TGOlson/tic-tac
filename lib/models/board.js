...
Board.prototype._makeCells = function() {
  return utils.makeArray(this.size, this._makeRow.bind(this));
};

Board.prototype._makeRow = function() {
  return utils.makeArray(this.size, this._createCell);
};
...
Board.prototype.getColumn = function(columnNum) {
  return utils.makeArray(this.size, function(i) {
...
Board.prototype.map = function(callback) {
  return _.map(this.cells, function(row, rowNum) {
